...
```{r}
3.4/1.6189
print(scale(cush[1:21,],F)*1.4746/5.7)
print(scale(cush[1:21, ], FALSE, c(3.4, 5.7)))
print(sqrt(mean(cush[1:21,2]^2)))
print(tp)
Z <- knn(scale(cush[1:21, ], FALSE, c(3.4, 5.7)),
        scale(cushT, FALSE, c(3.4, 5.7)), tp)
cushplot(xp, yp, class.ind(Z))
library("dplyr")
print(class.ind(Z) %>% head())
Z <- knn(scale(cush[1:21, ], FALSE, c(3.4, 5.7)),
...
print(list(c(fgl$type,res.multinom))[[1]])
print(list(c(fgl$type,res.multinom)))
